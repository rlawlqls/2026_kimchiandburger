...
const PHRASES: Phrase[] = [
  {
    en: "How much is the tteokbokki?",
    ko: "떡볶이 얼마예요?",
    romaji: "Ttuk-boh-kkee uhl-mah-yeh-yo?",
    syllables: [
      { ko: "떡", ro: "Ttuk" },
      { ko: "볶", ro: "boh" },
      { ko: "이", ro: "kkee" },
  ...
  {
    en: "Please give me one serving of tteokbokki.",
    ko: "떡볶이 하나 주세요",
    romaji: "Ttuk-boh-kkee hah-nah joo-seh-yo.",
    syllables: [
      { ko: "떡", ro: "Ttuk" },
      { ko: "볶", ro: "boh" },
      { ko: "이", ro: "kkee" },
  ...
  {
    en: "Does tteokbokki contain garlic?",
    ko: "떡볶이에 마늘 들어가나요?",
    romaji: "Ttuk-boh-kkee-eh mah-neul duh-ruh-gah-nah-yo?",
    syllables: [
      { ko: "떡", ro: "Ttuk" },
      { ko: "볶", ro: "boh" },
      { ko: "이", ro: "kkee" },
